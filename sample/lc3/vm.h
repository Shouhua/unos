...
typedef enum {
    VM_ADDR_KBSR = 0xfe00, // keyboard status register
    VM_ADDR_KBDR = 0xfe02, // keyboard data register
    VM_ADDR_DSR  = 0xfe04, // display status register
    VM_ADDR_DDR  = 0xfe06, // display data register
    VM_ADDR_MCR  = 0xfffe, // machine control register
} vm_addr_special;
...
typedef enum {
    ...
    VM_REG_7,
    VM_REG_PC,
    VM_REG_PSR, // processor status register, PSR[0]-postive, PSR[1]-zero, PSR[2]-negative
    VM_REG_COUNT
} vm_reg;
